        ...
        <div id="page-inner">
            ...
            <form action="/Management/iconUpload" method="post"  enctype="multipart/form-data">
                ...
                <label for="L1List">选择分类</label>
                    ...
                    <img id="iconPreview" class="img-responsive" <c:if test="${l2fIconLocation==null}"> hidden="hidden"</c:if> src="<% String iconPath = request.getContextPath()+"/FM"+"/"+Constants.ICON_UPLOAD_PATH+"/"; out.println(iconPath); %>${l2fIconLocation}"/>
